...
$xoopsOption['template_main'] = 'latest_brochure.html';
...
$xt = new PageflipBrochure ("latest", $cat_id);

//echo "BID:".$xt->brochure_id;

//echo "CID:".$cat_id;

$xoopsTpl->assign('brochure_id',$xt->brochure_id);
$xoopsTpl->assign('brochure_title',$xt->brochure_title);
$xoopsTpl->assign('brochure_pageheight',$xt->brochure_pageheight);
